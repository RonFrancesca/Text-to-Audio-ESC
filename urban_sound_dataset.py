...
class UrbanSoundDatasetValTest(Dataset):
    ...
    def __getitem__(self, index):
        ...
        signal_slices_stacked = torch.zeros(N_slices,self.patch_lenght_samples,self.patch_lenght_samples)
        
        # for each slice
        for slice in range(N_slices):
            signal_slices_stacked[slice] = signal[:, :, slice:slice+self.patch_lenght_samples]
