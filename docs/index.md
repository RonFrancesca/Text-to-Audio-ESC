...
Accompanying website to the paper _Synthetic training set generation using text-to-audio models for environmental sound classification, Francesca Ronchini, Luca Comanducci, Fabio Antonacci, accepted @ DCASE Workshop 2024_
